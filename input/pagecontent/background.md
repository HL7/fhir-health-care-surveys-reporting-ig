...
This IG aligns with the Health Data, Technology, and Interoperability: Certification Program Updates, Algorithm Transparency, and Information Sharing (HTI-1) Final Rule, which adopts the United States Core Data for Interoperability (USCDI) Version 3 and US Core Profiles V6.1.0 as the baseline standard as of January 1, 2026. For comprehensive mappings between USCDI Version 3 and US Core 6.1.0, see [US Core USCDI Guidance]({{site.data.fhir.ver.hl7fhiruscore}}/uscdi.html).
