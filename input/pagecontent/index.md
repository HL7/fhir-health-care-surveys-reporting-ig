...
From a regulatory alignment standpoint, this IG is closely aligned with [USCDI Version 3.0](https://www.healthit.gov/isp/united-states-core-data-interoperability-uscdi#uscdi-v3) and [US Core 6.1.0](https://hl7.org/fhir/us/core/STU6.1/) as specified in the Assistant Secretary for Technology Policy (ASTP)'s Health Data, Technology, and Interoperability: Certification Program Updates, Algorithm Transparency, and Information Sharing (HTI-1) Final Rule. While this NHCS FHIR IG aligns with USCDI V3/US Core 6.1.0 to the greatest extent possible, there is one exception. Since medications administered during encounters have been collected in the National Health Care Surveys for decades, and to avoid gaps in collection years, the IG includes the HCS Medication Administration Profile as the only deviation from standard US Core Profiles. Future releases will continue to align with ASTP's Health IT Certification Program regulations, the Standards Version Advancement Process (SVAP), USCDI, and other relevant digital standards for healthcare interoperability.

The Health Care Surveys Content Implementation Guide (IG) specifies how to enable health care organizations to implement [Health Care Surveys Use Cases](usecases.html) outlined in the IG.
...
* [US Core Implementation Guide - STU 6.1.0](http://hl7.org/fhir/us/core/STU6.1/) (2023-06-30), which aligns with U.S. Core Data for Interoperability (USCDI) v3, July 2021
...
* [Use Cases](usecases.html) - The use cases provide business context for the IG and information that implementers should familiarize themselves
  with prior to reading the remainder of the IG.
* [Detailed Specification](specification.html) - The formal specification identifying the requirements for the implementers.
